package com.example.dean3.Fragement;
...
import com.example.dean3.MainActivity;
...
public class TrangChuFragment extends Fragment {
    RecyclerView rcView ;
    ArrayList<ItemTrangChu> list;
    ItemTrangChuAdapter itemTrangChuAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rcView=view.findViewById(R.id.rvTrangChu);
        //list = App.
